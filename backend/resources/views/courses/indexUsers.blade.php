...
<div class="blockTitle">
	<h2 class="mainTitle">Les apprenants du cours</h2>
				...
				@foreach( $inCourseStudents as $student )
					<li class="box__group--list--list box__group--students">
						...
						<div class="box__list__rightButtons">
							...
							@if( \Auth::user()->status == 1 )
								<a title="Retirer cet apprenant de mon cours" class="unlink box__list__rightButton deleteButtonBg" href="{!! action( 'CourseController@removeStudentFromCourse', ['id_course' => $course->id, 'id_user' => $student->id] ) !!}">
